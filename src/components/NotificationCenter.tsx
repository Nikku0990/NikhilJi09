  ...
  return (
    <>
      ...
      <button
        ...
        className="fixed top-24 right-4 z-30 p-3 bg-[var(--card)] border border-white/10 rounded-full hover:bg-white/5 transition-colors shadow-lg"
      >
      ...
      {/* Notification Center */}
      {showCenter && (
        <div className="fixed top-36 right-4 z-30 w-80 max-h-96 bg-[var(--card)] border border-white/10 rounded-xl shadow-2xl overflow-hidden slide-up">
